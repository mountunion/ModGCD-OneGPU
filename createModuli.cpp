...
{
  static constexpr uint32_t SIEVE_SZ = 1 << 30; //  Should handle all k-bit odd primes for k <= 32. 
...
int main(int argc, char *argv[])
{
  ...
  cerr << "There are " << mListSize << " " << L << "-bit primes." << endl;
  ...
  cerr << "There are only " << numUsable << " usable " << L << "-bit primes; ";
